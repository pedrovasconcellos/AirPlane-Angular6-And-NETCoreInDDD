    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b413cfc0-f53a-4765-9430-3912efcd79cb"), "1", new DateTime(2019, 4, 8, 4, 35, 59, 392, DateTimeKind.Local), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc1"), 111 });

            migrationBuilder.InsertData(
                table: "AirPlane",
                columns: new[] { "Id", "Code", "CreationDate", "ModelId", "NumberOfPassengers" },
                values: new object[] { new Guid("a714554f-f363-42f1-b41a-81ee85186622"), "3B", new DateTime(2019, 4, 8, 4, 35, 59, 394, DateTimeKind.Local), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc3"), 167 });

            migrationBuilder.InsertData(
                table: "AirPlane",
                columns: new[] { "Id", "Code", "CreationDate", "ModelId", "NumberOfPassengers" },
                values: new object[] { new Guid("a714554f-f363-42f1-b41a-81ee85186661"), "4", new DateTime(2019, 4, 8, 4, 35, 59, 394, DateTimeKind.Local), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc4"), 117 });
